...
: ${AMENT_CURRENT_PREFIX:="/home/avalor/ros2_ws/src/px4_remap/install/px4_remap"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_remap/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_remap/environment/path.sh"
