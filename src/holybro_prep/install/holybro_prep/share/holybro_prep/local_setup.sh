...
: ${AMENT_CURRENT_PREFIX:="/home/avalor/holybro_avia/src/holybro_prep/install/holybro_prep"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/holybro_prep/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/holybro_prep/environment/path.sh"
